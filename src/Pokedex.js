...
const Pokedex = () => {
    ...
    const [displayImage, setDisplayImage] = useState("https://cdn0.iconfinder.com/data/icons/movies-11/32/pokemon_movie_cinema_ball_pokeball-512.png");
    ...
    return (
        <div className="FlexContainer">
            ...
            <div className="MainScreen">
                ...
                <textarea className="PokemonNameSearch"
                    onChange={(event) => {
                    ...
                    <div className="MainScreen2">
                        <div className="FlexContainer">
                            ...
                            <div className="YellowLight">
                                <div className="YellowLight2">

                                </div>
                            </div>

                            <div className="GreenLight">
                                <div className="GreenLight2">

                                </div>
                            </div>
                        </div>
                        <div className="DisplayScreen2">
                            {displayValue}
                        </div>
